        ...
        <div class="col-9">
            <div class="card" style="margin-top: 20px;">
                <div class="card-header">
                    ...
                    <button class="btn btn-sm btn-primary float-end" data-bs-target="#add-bot-btn" data-bs-toggle="modal">
                        创建新Bot
                    </button>
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            <tr v-for="bot in bots" :key="bot.id">
                                ...
                                <td>
                                    <button class="btn  btn-secondary" style="margin-right: 10px;" :data-bs-target="'#update-bot-modal-' + bot.id" data-bs-toggle="modal">修改</button>
                                    <button class="btn btn-danger" @click="remove_bot(bot)">删除</button>
